...
class ClientController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('SaaSInfoManagerInfoManagerBundle:Client:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SaaSInfoManagerInfoManagerBundle:Client:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SaaSInfoManagerInfoManagerBundle:Client')->find($id);
        ...
        return $this->render('SaaSInfoManagerInfoManagerBundle:Client:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SaaSInfoManagerInfoManagerBundle:Client:edit.html.twig', array(
            'entity'      => $entity,
